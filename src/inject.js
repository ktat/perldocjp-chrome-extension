var pjp_doc_name = document.querySelector('#pjp_doc_name').innerTEXT;
var pjp_url      = document.querySelector('#pjp_url').innerTEXT;
var pjp_timeout  = document.querySelector("#pjp_timeout") || 5;
